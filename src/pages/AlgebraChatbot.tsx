    ...
    if ((input.includes('বর্গ') || input.includes('square') || input.includes('²') || input.includes('^2') || 
      ...
      try {
        ...
        if (expression.includes('বর্গ')) {
          expression = expression.replace(/বর্গ/gi, '').trim();
        }
        
        // Handle ² symbol
        expression = expression.replace(/²/g, '').trim();
        
        console.log('Extracted expression for squaring:', expression);
